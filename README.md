...
I'm a **Software Engineer based in Indonesia 🇮🇩**, specializing in iOS development with experience in web development and AI-assisted software engineering.

* 🍎 Building production iOS applications with **Swift, UIKit & SwiftUI**
...
`MVVM` • `Clean Architecture` • `MVC` • `REST API` • `WebSocket` • `Keychain`
...
`🧠 Artificial Intelligence` • `⚡ Developer Productivity` • `🔐 Application Security`
